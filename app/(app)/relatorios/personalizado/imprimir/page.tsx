  ...
  return (
    <>
      ...
      <style>{`
        ...
        .folha a { color:#14161a; text-decoration:none; }
      ...
      <div className="folha">
        ...
        <div className="cab-timbre" style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 16, paddingBottom: 10, marginBottom: 16 }}>
          <div>
            ...
            {office?.cnpj && <div style={{ fontSize: 9.5, color: "#3d4045" }}>CNPJ {office.cnpj}</div>}
          </div>
          <div style={{ textAlign: "right", fontSize: 9.5, color: "#3d4045" }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: "#14161a" }}>Relatório de produção</div>
            <div>
        ...
        {!resultado ? (
          ...
          <>
            <p style={{ fontSize: 9.5, color: "#3d4045", marginBottom: 14 }}>
            ...
            <div style={{ display: "flex", gap: 24, marginBottom: 18, breakInside: "avoid" }}>
              <div style={{ flex: 1 }}>
                <h2 style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: ".08em", color: "#3d4045", marginBottom: 6 }}>Por pessoa</h2>
                <table>
                  <tbody>
              ...
              <div style={{ flex: 1 }}>
                <h2 style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: ".08em", color: "#3d4045", marginBottom: 6 }}>Por assessoria</h2>
                <table>
                  <tbody>
            ...
            {/* ---------- DETALHAMENTO ---------- */}
            <h2 style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: ".08em", color: "#3d4045", marginBottom: 6 }}>
