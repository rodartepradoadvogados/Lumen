  ...
  return (
    <>
      ...
      <style>{`
        ...
        .folha a { color:#23211c; text-decoration:none; }
      ...
      <div className="folha">
        ...
        <div className="cab-timbre" style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 16, paddingBottom: 10, marginBottom: 16 }}>
          <div>
            ...
            {office?.cnpj && <div style={{ fontSize: 9.5, color: "#45413c" }}>CNPJ {office.cnpj}</div>}
          </div>
          <div style={{ textAlign: "right", fontSize: 9.5, color: "#45413c" }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: "#23211c" }}>Relatório de produção</div>
            <div>
        ...
        {!resultado ? (
          ...
          <>
            <p style={{ fontSize: 9.5, color: "#45413c", marginBottom: 14 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginBottom: 18 }}>
              {resultado.blocos.map((b) => (
                <div key={b.chave} style={{ borderLeft: "3px solid #23211c", padding: "4px 12px", minWidth: 120 }}>
                  <div style={{ fontSize: 19, fontWeight: 700, lineHeight: 1.1 }}>{b.valor}</div>
                  <div style={{ fontSize: 9.5, color: "#45413c" }}>{b.rotulo}</div>
            ...
            <div style={{ display: "flex", gap: 24, marginBottom: 18, breakInside: "avoid" }}>
              <div style={{ flex: 1 }}>
                <h2 style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: ".08em", color: "#45413c", marginBottom: 6 }}>Por pessoa</h2>
                <table>
                  <tbody>
              ...
              <div style={{ flex: 1 }}>
                <h2 style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: ".08em", color: "#45413c", marginBottom: 6 }}>Por assessoria</h2>
                <table>
                  <tbody>
            ...
            {/* ---------- DETALHAMENTO ---------- */}
            <h2 style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: ".08em", color: "#45413c", marginBottom: 6 }}>
