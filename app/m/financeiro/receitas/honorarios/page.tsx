...
export default async function MobileLancarHonorariosGeralPage() {
  ...
  return (
    <div className="p-4 space-y-4 animate-fade-in">
      <Link href="/m/financeiro/receitas" className="inline-flex items-center gap-1 text-xs font-semibold text-navy-800/50 dark:text-cream-50/50">
      ...
      <div>
        ...
        <p className="text-sm text-navy-800/50 dark:text-cream-50/50">Escolha o processo — honorário sempre fica vinculado a um processo</p>
      </div>

      {cases.length === 0 ? (
        <p className="text-sm text-navy-800/45 dark:text-cream-50/45 py-6 text-center">Nenhum processo ativo cadastrado ainda.</p>
      ) : (
