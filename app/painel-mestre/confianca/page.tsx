...
export default async function ConfiancaPage() {
  ...
  return (
    <div className="p-6 max-w-[900px] mx-auto animate-fade-in space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Confiança e LGPD</h1>
      ...
      <LumenPanel>
        ...
        <div className="p-5 text-sm text-white/75 space-y-2">
          <p>
            Cada um dos <strong className="text-white font-mono tabular-nums">{officeCount}</strong> escritório(s)
      ...
      <LumenPanel>
        ...
        <div className="p-5 text-sm text-white/75 space-y-2">
          ...
          <p>
            <Link href="/painel-mestre/cofre" className="text-marca-tx font-semibold hover:underline">
