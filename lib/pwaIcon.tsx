    ...
    >
      <div
        style={{
          ...
          border: `${Math.max(1, px(1.3 / 120))}px solid rgba(201, 150, 47, 0.35)`,
        }}
      />
      {/* painel ouro */}
      <div
      ...
      <div style={{ position: "absolute", left: px(50 / 120), top: px(30 / 120), width: px(6 / 120), height: px(46 / 120), background: "#16191d" }} />
      <div style={{ position: "absolute", left: px(50 / 120), top: px(72 / 120), width: px(37 / 120), height: px(6 / 120), background: "#16191d" }} />
      {/* vértice + base em bordô */}
      <div style={{ position: "absolute", left: px(50 / 120), top: px(72 / 120), width: px(6 / 120), height: px(6 / 120), background: "#cd5f77" }} />
      <div style={{ position: "absolute", left: px(33 / 120), top: px(88 / 120), width: px(54 / 120), height: px(2.4 / 120), background: "#cd5f77" }} />
    </div>
  );
}
