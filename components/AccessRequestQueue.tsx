        ...
        <div key={req.id} className="p-5 flex items-start justify-between gap-3 flex-wrap">
          ...
          <div className="flex gap-2 shrink-0">
            <button
              ...
              className="inline-flex items-center gap-1.5 bg-concluido hover:bg-concluido text-rotulo text-xs font-semibold px-3 py-2 disabled:opacity-50"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 bg-atencao hover:opacity-90 text-rotulo text-xs font-semibold px-3 py-2 disabled:opacity-50"
            >
              <X size={13} /> Negar
            </button>
          </div>
