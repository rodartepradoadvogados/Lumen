...
export default function AssessoriaSelect({ assessorias, inputClassName }: { assessorias: AssessoriaOption[]; inputClassName: string }) {
  ...
  return (
    <div>
      ...
      <select name="assessoriaId" defaultValue="" className={inputClassName}>
