...
export default function TimesheetTimer({ initialSeconds }: { initialSeconds: number }) {
  ...
  return (
    <span title="Tempo desta sessão (reinicia após um período de inatividade)" className="hidden lg:flex items-center gap-1 text-etiqueta text-tx-3 font-medium tabular-nums">
