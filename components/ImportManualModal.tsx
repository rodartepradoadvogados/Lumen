  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 justify-center bg-sf border border-regua hover:bg-sf-apoio text-tx text-sm font-semibold px-4 py-2.5 w-fit"
      >
        ...
        <div className="fixed inset-0 z-50 bg-grafite-900/40 flex items-center justify-center p-4">
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-regua sticky top-0 bg-sf ">
              <h3 className=" font-bold text-lg text-tx">Legenda para Preenchimento</h3>
            ...
            <div className="p-6 space-y-6 text-sm text-tx">
              ...
              <section className="space-y-2">
                <h4 className=" font-bold text-marca-tx uppercase tracking-wide text-xs">
                  1. Coluna “Tipo” — o que cada valor faz
                </h4>
                <div className=" border border-regua divide-y divide-regua overflow-hidden">
              ...
              <section className="space-y-2">
                ...
                <div className=" bg-sf-apoio border border-regua px-4 py-3 space-y-1">
              ...
              <section className="space-y-2">
                ...
                <p className="text-xs text-aviso bg-aviso-bg border border-linha-aviso rounded-md px-3 py-2">
