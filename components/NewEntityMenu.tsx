  ...
  return (
    <div className="relative" ref={ref}>
      ...
      <button
        ...
        className="hidden sm:flex items-center gap-1.5 h-8 rounded-md bg-acao-suave border border-marca-tx hover:bg-acao hover:text-acao-tx text-marca-tx text-sm font-medium px-3.5 transition-colors"
      >
        <Plus size={16} /> Novo
      </button>
      {open && (
