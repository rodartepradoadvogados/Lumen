    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button
          ...
          className="shrink-0 text-[13px] font-semibold px-2.5 py-1.5 bg-sf-apoio text-tx-2"
        >
          Hoje
        </button>
      </div>
      ...
      <button
        ...
        onClick={handleSave}
        disabled={pending}
        className="w-full text-[13px] font-semibold text-acao-tx bg-acao hover:bg-acao-hover px-3.5 py-2 disabled:opacity-50 transition-colors"
      >
