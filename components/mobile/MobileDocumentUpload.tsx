  ...
  if (!file) {
    return (
      <button
        ...
        className="w-full flex items-center justify-center gap-1.5 text-corpo font-semibold text-marca-tx hover:text-tx border border-dashed border-regua hover:border-marca-tx py-2.5 transition-colors"
      >
