...
export default function MobileGlobalSearch() {
  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      ...
      {showDropdown && (
        <div className="absolute left-0 right-0 top-full mt-2 rounded-lg bg-sf border border-regua shadow-pop z-50 overflow-hidden max-h-[60vh] overflow-y-auto scrollbar-thin">
