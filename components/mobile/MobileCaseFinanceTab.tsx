                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className={clsx("text-corpo mt-0.5", r.noDueDate || isApurar ? "text-tx-2" : PRAZO_URGENCIA_TEXT[urgencia])}>
                    ...
                    <div className="text-right shrink-0">
                      ...
                      {r.status === "PARCIAL" && <p className="text-corpo tabular-nums text-tx-2">saldo {formatCurrency(saldo)}</p>}
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className={clsx("text-corpo mt-0.5", p.noDueDate ? "text-tx-2" : PRAZO_URGENCIA_TEXT[urgencia])}>
                        {p.noDueDate ? "Sem vencimento" : formatRelativeDueDate(p.dueDate)}
                      </p>
                      {p.reimbursementReceivable && (
                        <p className="mt-1 flex items-center gap-1.5 flex-wrap text-corpo text-tx-2">
