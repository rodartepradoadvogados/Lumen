        ...
        <div className="flex-1 min-w-0">
          {platform === "ios" ? (
            ...
            <>
              ...
              <p className="text-[13px] text-white/70 mt-1">Acesso rápido direto da tela inicial do seu celular.</p>
              <button
                onClick={install}
                className="mt-2 inline-flex items-center gap-1.5 bg-acao hover:bg-acao-hover text-acao-tx text-[13px] font-semibold px-3 py-1.5 "
              >
