...
// Card de "Dar Baixa" / confirmar recebimento, extraído do SettleButton para poder ser
// aberto também a partir de outros pontos (Central de Alertas, listagens do painel),
// sem precisar do botão que originalmente disparava o modal.
