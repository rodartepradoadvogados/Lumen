      ...
      {requests.map((r) => (
        <div key={r.id} className="flex items-center gap-3 px-5 py-3.5">
          ...
          <button
            ...
            disabled={pending}
            className="flex items-center gap-1 text-etiqueta font-semibold text-emerald-700 hover:text-emerald-900 px-2.5 py-1.5 bg-emerald-500/10 hover:bg-emerald-500/20 disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={pending}
            className="flex items-center gap-1 text-etiqueta font-semibold text-red-700 hover:text-red-900 px-2.5 py-1.5 bg-red-500/10 hover:bg-red-500/20 disabled:opacity-50"
          >
            <X size={12} /> Recusar
          </button>
        </div>
