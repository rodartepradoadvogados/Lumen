    ...
    <div className="space-y-4">
                ...
                {cat.items.map((t) => (
                  <div key={t.id} className="group relative flex items-center gap-2 bg-sf-apoio border border-regua px-3 py-2">
                    ...
                    <button
                      ...
                      className="absolute top-1 right-1 p-1 text-tx-3 opacity-0 group-hover:opacity-100 hover:text-vinho hover:bg-sf transition-all bg-sf-apoio rounded-md"
                    >
                      <X size={11} />
                    </button>
                  </div>
      ...
      <div className="pt-2 border-t border-regua space-y-2.5">
        ...
        {driveConnected ? (
          ...
          <p className="text-etiqueta text-aviso bg-aviso-bg rounded-md px-2.5 py-1.5">
